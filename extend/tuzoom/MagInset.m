function MagInset(h, ax, ZoomArea, InsetPos, Lines)
    ...
    if(BadInput == 0)
        ...
        h1=annotation('rectangle',[zax(1) zay(1) (zax(2) - zax(1)) (zay(2) - zay(1))]);
        ...
        iaxes.FontName=MainAx.FontName;
        ...
        button2=questdlg('是否保留？','是否保留','保留','取消','取消');
        if strcmp(button2,'取消')
        delete(gca);
        delete(h1);
        delete(iaxes);
        delete(h2);
